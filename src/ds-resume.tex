...
\project{meter-made}{
    \projachievement{
        \href{https://nbviewer.org/github/reedmarkham/meter-made/blob/main/meter_made.ipynb}{Predicted parking tickets} in Washington, DC with over 81\% accuracy, precision, and recall; \href{https://meter-made-api-g54t3azreq-uc.a.run.app/docs}{deployed API} and \href{https://meter-made-ui-397485407730.us-east4.run.app/}{interactive UI} to serve model
    }
    \projachievement{
