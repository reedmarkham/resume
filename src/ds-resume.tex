...
\project{scotustician}{
    \projachievement{
        \url{https://github.com/reedmarkham/scotustician}{GPU-accelerated data pipeline for text embeddings} and \url{https://github.com/reedmarkham/scotustician-db}{vector database} for \tech{Oyez.org API} Supreme Court oral argument transcripts deployed on \tech{AWS}
    }
    \projachievement{
...
\project{meter-made}{
    \projachievement{
        \url{https://nbviewer.org/github/reedmarkham/meter-made/blob/main/meter_made.ipynb}{Predicted parking tickets} in Washington, DC with over 81\% accuracy, precision, and recall; \url{https://meter-made-api-g54t3azreq-uc.a.run.app/docs}{deployed API} and \href{https://meter-made-ui-397485407730.us-east4.run.app/}{interactive UI} to serve model
    }
    \projachievement{
        Skills: \tech{Python}, \tech{scikit-learn}, \tech{LightGBM}, \tech{FastAPI}, \tech{TypeScript}, \tech{Next.js}, \tech{Docker}, \tech{GCP}, \tech{GitHub Actions}
    }
}
