...
\experience{SiriusXM}{%
    ...
    \role{Data Scientist, Product Analytics}{2019 - 2022}
    {
        ...
        \achievement{
            Built internal \tech{Python} libraries to automate ad-hoc workflows using \tech{GCP Dataproc} and \tech{AWS Redshift}, and deployed \tech{Streamlit} app to enable self-service analytics on \tech{BigQuery}
        }
    }
}
