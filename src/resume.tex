...
\experience{National Council of Architectural Registration Boards}{%
    ...
    \achievement{
        Led migration to \tech{git} for 15+ legacy \tech{Python} scripts and \tech{AWS CloudFormation} templates, checking key data pipelines and infrastructure into \tech{version control}
    }
    \achievement{
