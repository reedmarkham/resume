...
\experience{National Council of Architectural Registration Boards}{%
    ...
    \achievement{
        Integrated vendor \tech{APIs} into 10+ data pipelines achieving 99.7\% success rate using \tech{Python}, \tech{AWS Glue}, and \tech{Redshift} to support the organization's Data team
    }
    \achievement{
    ...
    \achievement{
        Refactored legacy ETL process spanning 3K lines of \tech{SQL} to reduce size of codebase by 40\% and implement \tech{AWS Step Functions} for improved orchestration
    }
    \achievement{
        Designed and implemented \tech{retrieval-augmented generation} tool for Customer Support team using \tech{AWS Bedrock}, \tech{Postgres} vector database, \tech{Docker}, and \tech{FastAPI} for deployment
    }
    \achievement{
